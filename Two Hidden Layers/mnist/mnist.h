...
int get_input(float zVector[], mnist_data *data, int zLabel, float noise)
{
    char pixel[1];
    double val;
...
int draw_input(float zVector[], int zLabel)
{
    char pixel[1];
    double val;
